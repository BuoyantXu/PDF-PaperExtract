...
login("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")
...
image_path = r"F:\local_projects\PDF-PaperExtract\outputs\1740443277072.jpg"
output_path = r"F:\local_projects\PDF-PaperExtract\outputs\table_structure.json"
...
for i, column in enumerate(table_structure['columns']):
    ...
    column_image.save(f"outputs/table/column_{i + 1}.jpg")
...
for i, column in enumerate(table_structure['rows']):
    ...
    row_image.save(f"outputs/table/row_{i + 1}.jpg")
